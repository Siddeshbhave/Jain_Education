...
<body>
  ...
  <section id="header">
    <div class="header container">
      <div class="nav-bar">
        <div class="brand">
          <a href="#hero"><h1><span>J</span>ain <span>E</span>ducation</h1></a>
        </div>
        <div class="nav-list">
          <div class="hamburger"><div class="bar"></div></div>
          <ul>
            <li><a href="#hero" data-after="Home">Home</a></li>
            <li><a href="#services" data-after="Service">Listings</a></li>
            <li><a href="#projects" data-after="Projects">Category</a></li>
            <li><a href="#about" data-after="About">Blog</a></li>
  ...
  <section id="hero">
    <div class="hero container">
      <div class="header1">
        <form>
          <h1 style="margin-bottom: 50px;">Everything</h1>
          <div class="form-box">
            <input type="text" class="search-field business" name="" value="" placeholder="Search here..">

            <input type="text" class="search-field location" name="" value="" placeholder="Search here..">
